...
{
  print("Protocole non conforme, ce script doit être lancé pour un protocole Point Fixe")
}else{
...
#get date-night
pourDateNuit=IdC2$TimeNum-12*3600 #bricolage-décalage de 12 heures pour ramener à la date du début de nuit
