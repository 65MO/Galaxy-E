...
if(testTF2>1){stop("Problème stéréo : les 2 canaux semblent être en enregistrement direct")}
...
write.csv2(SummPartTron,paste0(substr(args[1],1,nchar(args[1])-9),"-detail.csv"),row.names=F)
